        ...
        >
          ...
          <div className="mt-2 flex gap-2">
            <input
              ...
              placeholder="t.ex. 15"
              className="mono w-24 rounded-md border border-input bg-background px-4 py-3 text-lg outline-none transition focus:border-ring focus:ring-2 focus:ring-ring/40"
            />
            <button
              type="submit"
